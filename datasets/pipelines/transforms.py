...
class SeqRandomCropWithDepth(object):
    ...
    def __call__(self, results):
        ...
        if len(outs) == 2 and self.check_id_match > 0:
    ...
    def check_match(self, ref_results, results):
        ref_ids = ref_results['gt_instance_ids'][ref_results['gt_instance_ids'] < self.check_id_match].tolist()
        gt_ids = results['gt_instance_ids'][results['gt_instance_ids'] < self.check_id_match].tolist()
